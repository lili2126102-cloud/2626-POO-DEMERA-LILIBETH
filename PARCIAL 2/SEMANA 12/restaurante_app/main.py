...
def registrar_producto_ui(restaurante: Restaurante, archivo_servicio: ArchivoServicio) -> None:
    ...
    while True:
        try:
            ...
            # El servicio valida duplicación de código en O(1) con el diccionario auxiliar
...
def buscar_producto_ui(restaurante: Restaurante, archivo_servicio: ArchivoServicio = None) -> None:
    ...
    # Consulta optimizada O(1) en el servicio
...
def registrar_usuario_ui(restaurante: Restaurante, archivo_servicio: ArchivoServicio) -> None:
    ...
    while True:
        try:
            ...
            # El servicio valida duplicación de ID en O(1) con el diccionario auxiliar
...
def realizar_venta_ui(restaurante: Restaurante, archivo_servicio: ArchivoServicio) -> None:
    ...
    while True:
        try:
            ...
            # Buscar el usuario con el servicio (búsqueda O(1))
            ...
            # Buscar el producto con el servicio (búsqueda O(1))
            ...
            # Intentar procesar la venta en el servicio de negocio (actualiza listas e índices auxiliares)
...
def consultar_ventas_usuario_ui(restaurante: Restaurante, archivo_servicio: ArchivoServicio = None) -> None:
    ...
    # Obtener ventas filtradas del servicio mediante el índice auxiliar O(1)
...
def main() -> None:
    ...
    # Configurar rutas relativas al módulo para la persistencia en JSON
    ...
    # Cargar productos almacenados y reconstruir índices auxiliares O(1)
    try:
    ...
    # Cargar usuarios almacenados y reconstruir índices auxiliares O(1)
    try:
    ...
    # Cargar ventas almacenadas y reconstruir índices auxiliares O(1)
    try:
    ...
    while True:
        ...
        print("       Colecciones Optimizadas O(1)    ")
        print("========================================")
